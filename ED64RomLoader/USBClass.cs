    ...
    public class UsbClass
    {
        ...
        private class Win32Wrapper
        {
            ...
            private struct DevBroadcastDeviceInterfaceBuffer
            {
                ...
                [FieldOffset(0)]
                public readonly Int32 dbch_size;
                [FieldOffset(4)]
                public readonly Int32 dbch_devicetype;
                [FieldOffset(8)]
                public readonly Int32 dbch_reserved;
            }
            ...
            {
                public readonly int dbcc_size;
                public readonly int dbcc_devicetype;
            ...
            public struct DEV_BROADCAST_DEVICEINTERFACE
            {
                ...
                public readonly Int32 dbcc_reserved;
            ...
            {
                public readonly Int32 dbcv_size;
                public readonly Int32 dbcv_devicetype;
                public readonly Int32 dbcv_reserved;
                public readonly Int32 dbcv_unitmask;
                public readonly Int16 dbcv_flags;
            }
            ...
            {
                public readonly Int32 dbcp_size;
                public readonly Int32 dbcp_devicetype;
                public readonly Int32 dbcp_reserved;
                [MarshalAs(UnmanagedType.ByValArray, SizeConst = 128)]
            ...
            {
                public readonly Int32 dbco_size;
                public readonly Int32 dbco_devicetype;
                public readonly Int32 dbco_reserved;
                public readonly Int32 dbco_identifier;
                public readonly Int32 dbco_suppfunc;
            }
        ...
        public bool IsQueryHooked
        {
            get
            {
                return _deviceEventHandle != IntPtr.Zero;
            }
        }
        ...
        public bool RegisterForDeviceChange(bool register, IntPtr windowsHandle)//System.Windows.Forms.Form f)
        {
            ...
            if (register)
            {
                ...
                _deviceEventHandle = Win32Wrapper.RegisterDeviceNotification(windowsHandle, buffer, (int)(Win32Wrapper.DEVICE_NOTIFY.DEVICE_NOTIFY_WINDOW_HANDLE | Win32Wrapper.DEVICE_NOTIFY.DEVICE_NOTIFY_ALL_INTERFACE_CLASSES));
                status = (_deviceEventHandle != IntPtr.Zero);
                if (!status)
                {
            ...
            else
            {
                ...
                {
                    status = Win32Wrapper.UnregisterDeviceNotification(_deviceEventHandle);
                }
                _deviceEventHandle = IntPtr.Zero;
            }
                ...
                switch (wParam.ToInt64())
                {
                    case (int)Win32Wrapper.DBTDEVICE.DBT_DEVICEARRIVAL:
                        ...
                        if (devType == Win32Wrapper.DBTDEVTYP.DBT_DEVTYP_DEVICEINTERFACE)
                        {
                            ...
                            if (UsbDeviceAttached != null) UsbDeviceAttached(this, e);
                        }
                        break;
                    ...
                    case (int)Win32Wrapper.DBTDEVICE.DBT_DEVICEQUERYREMOVE:
                        ...
                        if (devType == Win32Wrapper.DBTDEVTYP.DBT_DEVTYP_DEVICEINTERFACE)
                        {
                            ...
                            if (UsbDeviceQueryRemove != null) UsbDeviceQueryRemove(this, e);
                        }
                        break;
                    ...
                    case (int)Win32Wrapper.DBTDEVICE.DBT_DEVICEREMOVECOMPLETE:
                        ...
                        {
                            var e = new UsbDeviceEventArgs();
                            if (UsbDeviceRemoved != null) UsbDeviceRemoved(this, e);
                        }
                        break;
                }
            }
        ...
        public static bool GetUsbDevice(UInt32 vid, UInt32 pid, ref List<DeviceProperties> listOfDp, bool getComPort, uint? MI = null)
        {
            var intPtrBuffer = Marshal.AllocHGlobal(BUFFER_SIZE);
            var h = IntPtr.Zero;
            var dp = new DeviceProperties();
            //bool Status = false;
            ...
            try
            {
                ...
                var expectedInterfaceId = String.Empty;

                var expectedDeviceId = "VID_" + vid.ToString("X4") + "&" + "PID_" + pid.ToString("X4");
                ...
                if (h.ToInt64() != INVALID_HANDLE_VALUE)
                {
                    ...
                    while (success)
                    {
                        ...
                        if (success)
                        {
                            ...
                            //Create a Device Info Data structure
                            var devInfoData = new Win32Wrapper.SP_DEVINFO_DATA();
                                        ...
                                        if (Win32Wrapper.SetupDiGetDeviceRegistryProperty(h, ref devInfoData, (UInt32)Win32Wrapper.SPDRP.SPDRP_HARDWAREID, ref regType, intPtrBuffer, BUFFER_SIZE, ref requiredSize))
                                        {
                                                ...
                                                )
                                            {
                                                ...
                                                if (getComPort)
                                                {
                                                    ...
                                                    var hDeviceRegistryKey = Win32Wrapper.SetupDiOpenDevRegKey(h, ref devInfoData, (UInt32)Win32Wrapper.DICS_FLAG.DICS_FLAG_GLOBAL, 0, (UInt32)Win32Wrapper.DIREG.DIREG_DEV, (UInt32)Win32Wrapper.REGKEYSECURITY.KEY_READ);
                                                    if (hDeviceRegistryKey.ToInt64() == INVALID_HANDLE_VALUE)
                                                    {
                                                        lastError = (Win32Wrapper.WinErrors)Marshal.GetLastWin32Error();
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        var size = (UInt32)data.Capacity;

                                                        var result = Win32Wrapper.RegQueryValueEx(hDeviceRegistryKey, "PortName", 0, out type, data, ref size);
